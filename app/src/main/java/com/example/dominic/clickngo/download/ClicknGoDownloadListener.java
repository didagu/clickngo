 ...
 */
package com.example.dominic.clickngo.download;
...
public class ClicknGoDownloadListener implements DownloadListener {

	private final Activity mActivity;

	public ClicknGoDownloadListener(Activity activity) {
		mActivity = activity;
	}
