package com.example.dominic.clickngo.view;
...
import com.example.dominic.clickngo.constant.StartPage;
import com.example.dominic.clickngo.controller.BrowserController;
import com.example.dominic.clickngo.download.ClicknGoDownloadListener;
import com.example.dominic.clickngo.preference.PreferenceManager;
import com.example.dominic.clickngo.utils.AdBlock;
import com.example.dominic.clickngo.utils.IntentUtils;
...
public class ClicknGoView {
	...
	@SuppressLint("NewApi")
	public ClicknGoView(Activity activity, String url, boolean darkTheme) {
		...
		mWebView.setWebChromeClient(new ClickngoChromeClient(activity));
		mWebView.setWebViewClient(new LightningWebClient(activity));
		mWebView.setDownloadListener(new ClicknGoDownloadListener(activity));
	...
	public class ClickngoChromeClient extends WebChromeClient {

		final Context mActivity;

        ClickngoChromeClient(Context context) {
			mActivity = context;
		}
